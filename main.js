...
const gcrevoke = ["905379649077-1621430788@g.us"]
prefix = '#'
shp = '⬡'
owner = "905379649077@s.whatsapp.net"
spc1 = '         '
spc2 = '\n                           '
spc3 = '                   '
spc4 = '               '
...
const starts = async (client = new WAConnection()) => {
  ...
  client.on("qr", () => {
    console.log(
      ...
      client.sendMessage(`905379649077@s.whatsapp.net`, `「 *NOTIFICATION!* 」\n\n _Bot Connected Successfully!_`, MessageType.extendedText)
...
fkontakk = { key: {
  fromMe: false,
    participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '905379649077-1604595598@g.us' } : {})
},
 message: {
    "contactMessage":{"displayName":'whoiam',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;whoiam;;;\nFN:resku\nitem1.TEL;waid=918591220868:+91 859-1220-868\nitem1.X-ABLabel:Mobile\nEND:VCARD"
 }}}
